...
export default function Home() {
  ...
  const updatePantry = async () => {
    try {
      ...
      const pantryList: any[] = []; // Initialize an empty array for pantry items

      docs.forEach((doc) => {
        pantryList.push({ name: doc.id, ...doc.data() }); // Collect document IDs and data
      });

      setPantry(pantryList); // Update state with pantry items
    } catch (error) {
